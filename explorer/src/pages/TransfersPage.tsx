...
const TransfersPage: React.FC = () => {
    ...
    const toMillis = (input: string | number | undefined | null): number => {
        ...
        if (typeof input === 'string') {
            ...
            const normalized = s.replace(/(\.\d{3})\d+/, '$1'); // e.g. "....710772" → "....710"
                ...
                <div>
                    {allTransferEvents.map((event: Transfer | GenesisFunding) => {
                        ...
                        if (isGenesisFunding) {
                            ...
                            return (
                                <div key={funding.id} className="deployment-item fade-in"
                                    ...
                                    <div style={{
                                        ...
                                        <dl style={{
                                            ...
                                            <dd className="mono"
                                                style={{fontSize: '11px', margin: 0, color: 'var(--asi-pulse-blue)'}}>
                                                Genesis (System Mint)
                                            </dd>
                                            ...
                                            <dd className="mono"
                                                style={{fontSize: '11px', margin: 0, wordBreak: 'break-all'}}>
                            ...
                            <div key={transfer.id} className="deployment-item fade-in" style={{marginBottom: '1.5rem'}}>
                                <div style={{
                                    ...
                                    <dl style={{
                                        ...
                                        <dd style={{fontSize: '12px', margin: 0}}>
                    <span
                        className={transfer.status === 'success' || transfer.status === 'genesis_bond' ? 'text-success' : 'text-error'}>
